                                                    ...
                                                    children: <Widget>[
                                                      Column(
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          Text(
                                                              "Dist. Date : ${chickensIn['distribution_date']}",
                                                              style: TextStyle(
                                                                  color: Colors.grey,
                                                                  fontFamily: "Montserrat",
                                                                  fontSize: 12,
                                                      ...
                                                      Column(
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          Text(
                                                              "Distributed : ${chickensIn['distributed']}",
                                                              style: TextStyle(
                                                                  color: Colors.grey,
                                                                  fontFamily: "Montserrat",
                                                                  fontSize: 12,
