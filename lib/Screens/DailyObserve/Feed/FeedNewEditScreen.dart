...
class _FeedNewEditScreenState extends State<FeedNewEditScreen> {
  ...
  _getFarmSiteInformation() async {
    ...
    List<Map<String, dynamic>> inputTypesFromDB = await DatabaseHelper.instance.getWhere('input_types', ['input_types_ite_type'], ['Feed']);
          ...
          title: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                _buildFeedArticleSelectionForm(),
                _buildFeedUnitOfMeasurementForm(),
...
//                  valueMap['feed_batch'].toString() + ", " + valueMap['feed_kind'] + ", Storage " + valueMap['feed_storage'].toString(),
    ...
    return Column(
        ...
        children: <Widget>[
          ...
          TextFormField(
            ...
            initialValue: feedAmount != null ? feedAmount.toString() : null,
            decoration: InputDecoration(
              filled: true,
              fillColor: Colors.grey[100],
            ...
            onSaved: (String value){
              setState(() {
                ...
                warningList["feedAmountWarning"] = value == "" || value == null ? true : false;
              });
            },
  ...
  formSubmit() async{
    ...
    if(isNew == true){
      ...
      print(inserted_observed_input_uses_id);
  ...
  Widget build(BuildContext context) {
    ...
    setState(() {
      ...
      routeData['feedAmount'] != null ? feedAmount = routeData['feedAmount'] : null;
