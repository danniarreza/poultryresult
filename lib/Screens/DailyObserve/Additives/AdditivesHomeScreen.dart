...
class AdditivesHomeScreen extends StatefulWidget {
  @override
  _AdditivesHomeScreenState createState() => _AdditivesHomeScreenState();
}

class _AdditivesHomeScreenState extends State<AdditivesHomeScreen> {

  List<Map> additivesInspectionList = [
    {
      "addition_round": 1,
      "additive_article": "Vitamine C",
      "additive_amount": 1
    },
    {
      "addition_round": 2,
...
//                                  "Day : 293",
  ...
  _buildAdditivesInspectionCards(){
    return Expanded(
      child: Container(
        child: ListView.builder(
          itemCount: additivesInspectionList.length,
          itemBuilder: (BuildContext context, int index){
            Map dailyObserve = additivesInspectionList[index];
            return Padding(
              padding: EdgeInsets.fromLTRB(20, 0, 20, 10),
              child: Card(
                elevation: 1.5,
                ...
                child: ListTile(
                  contentPadding: EdgeInsets.symmetric(horizontal: 20, vertical: 15),
                  onTap: (){
                    Navigator.pushNamed(context, "/dailyobserveadditivesneweditscreen");
                  },
                  title: GestureDetector(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(
                          "Addition Round : ${dailyObserve['addition_round']}",
                          style: TextStyle(
                              color: Colors.black,
                              fontFamily: "Montserrat",
                              fontSize: 16,
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Column(
                                ...
                                children: <Widget>[
                                  Text(
                                      "Additive : ${dailyObserve['additive_article']}",
                                      style: TextStyle(
                                          color: Colors.black,
                                          fontFamily: "Montserrat",
                                          fontSize: 14,
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  Text(
                                      "Amount : ${dailyObserve['additive_amount']} [kg]",
                                      style: TextStyle(
                                          color: Colors.black,
                                          fontFamily: "Montserrat",
                                          fontSize: 14,
