...
//    print(new_management_location);
    ...
    _getAdditivesSelectedDate();
  }

  _getAdditivesSelectedDate() async {
    setState(() {
                  ...
                  child: Padding(
                    ...
                    child: Card(
                      ...
                      child: ListTile(
                        contentPadding: EdgeInsets.symmetric(horizontal: 20, vertical: 15),
                        onTap: (){
                          Navigator.pushNamed(context, "/dailyobserveadditivesneweditscreen", arguments: {
                            ...
                            'additiveAmount' : dailyObserve['observed_input_uses_total_amount'],
                        ...
                        title: GestureDetector(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(
                                "Addition Round : " + dailyObserve['observed_input_uses_treatment_nr'].toString(),
                                style: TextStyle(
                                    color: Colors.black,
                                    fontFamily: "Montserrat",
                                    fontSize: 16,
